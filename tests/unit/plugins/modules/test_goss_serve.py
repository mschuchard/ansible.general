...
from ansible_collections.mschuchard.general.plugins.modules import goss_serve
...
def test_goss_serve_format_vars(capfd):
    ...
    utils.set_module_args({'format': 'json', 'format_opts': 'pretty', 'vars': f'{utils.fixtures_dir()}/goss.yaml'})
    with pytest.raises(SystemExit, match='1'):
        goss_serve.main()
